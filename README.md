[Notebook_Limpieza_Raw_Data_Ventas (2).ipynb](https://github.com/user-attachments/files/29185553/Notebook_Limpieza_Raw_Data_Ventas.2.ipynb)
# Notebook_Limpieza_EjecutadoMADE{
 "cells": [
  {
   "cell_type": "markdown",
   "id": "40095973",
    ...
    },
    {
     "data": {
      "text/html": [
       ...
       "      <th>EmailCliente</th>\n",
       "      <th>Telefono</th>\n",
       "      <th>TotalReportado</th>\n",
       "      <th>Observaciones_Origen</th>\n",
       "    </tr>\n",
       "  </thead>\n",
       "  <tbody>\n",
       "    <tr>\n",
       ...
       "      <td>9988-7766</td>\n",
       "      <td>13775</td>\n",
       "      <td>Posible duplicado exacto</td>\n",
       "    </tr>\n",
       "    <tr>\n",
       "      <th>2</th>\n",
       "      <td>V-1002</td>\n",
       ...
       "      <td>Pagado</td>\n",
       "      <td>A. Cruz</td>\n",
       "      <td>carlos.mejia@example.com</td>\n",
       "      <td>9999 1122</td>\n",
       "      <td>700</td>\n",
       "      <td></td>\n",
       "    </tr>\n",
       ...
       "      <td>pagado</td>\n",
       "      <td>A. Cruz</td>\n",
       "      <td>maria.santos@example</td>\n",
       "      <td>8888-1234</td>\n",
       "      <td>428</td>\n",
       "      <td>Ciudad abreviada</td>\n",
       "    </tr>\n",
       "    <tr>\n",
       "      <th>4</th>\n",
       "      <td>V-1004</td>\n",
       ...
       "      <td>3366-2211</td>\n",
       "      <td>3375</td>\n",
       "      <td>Fecha faltante; descuento como entero</td>\n",
       "    </tr>\n",
       "    <tr>\n",
       "      <th>6</th>\n",
       "      <td>V-1006</td>\n",
       ...
       "      <td>Pagado</td>\n",
       "      <td>A. Cruz</td>\n",
       "      <td>cliente.desconocido@example.com</td>\n",
       "      <td>9988-1111</td>\n",
       "      <td>3900</td>\n",
       "      <td>ClienteId faltante</td>\n",
       "    </tr>\n",
       "    <tr>\n",
       "      <th>8</th>\n",
       "      <td>V-1008</td>\n",
       ...
       "      <td>Entregado</td>\n",
       "      <td>M. Reyes</td>\n",
       "      <td>karla.nunez@example.com</td>\n",
       "      <td>2233-4455</td>\n",
       "      <td>850</td>\n",
       "      <td>Estado fuera de catálogo</td>\n",
       "    </tr>\n",
       "    <tr>\n",
       "      <th>9</th>\n",
       "      <td>V-1009</td>\n",
       ...
       "      <td>Pagado</td>\n",
       "      <td>L. Torres</td>\n",
       "      <td>roberto.diaz@example.com</td>\n",
       "      <td>9988-2222</td>\n",
       "      <td>-500</td>\n",
       "      <td>Precio negativo</td>\n",
       "    </tr>\n",
       "  </tbody>\n",
       "</table>\n",
       "</div>"
      ...
      "text/plain": [
       "  IdVenta           FechaVenta ClienteId        ClienteNombre          Ciudad  \\\n",
       "0  V-1001  2026-05-01 00:00:00      C001            Ana López     Tegucigalpa   \n",
       "1  V-1001  2026-05-01 00:00:00      C001            Ana López     Tegucigalpa   \n",
       "2  V-1002           01/05/2026     c002         Carlos Mejía   San Pedro Sula   \n",
       "3  V-1003           2026/05/02      C003         María Santos             SPS   \n",
       "4  V-1004         mayo 3, 2026      C004          Jose Rivera        La Ceiba   \n",
       "5  V-1005                           C005         Sofia García         Choloma   \n",
       "6  V-1006           2026-13-05      C006        Luis Martínez       Comayagua   \n",
       "7  V-1007           2026-05-04            Cliente Desconocido     Tegucigalpa   \n",
       "8  V-1008           2026-05-04      C008        Karla Núñez          la ceiba   \n",
       "9  V-1009           2026-05-05      C009         Roberto Díaz     El Progreso   \n",
       "\n",
       "        Producto   Categoria Cantidad PrecioUnitario Descuento     MetodoPago  \\\n",
       "0         Laptop  Tecnología        1          14500      0.05        Tarjeta   \n",
       "1         Laptop  Tecnología        1          14500      0.05        Tarjeta   \n",
       "2          mouse  tecnologia        2      L. 350.00         0       efectivo   \n",
       "3        Teclado  tecnologia        1         450,50        5%  Transferencia   \n",
       "4        Monitor  Tecnología        0           3200         0        Tarjeta   \n",
       "5  Silla Oficina     Muebles        3       1,250.00        10       efectivo   \n",
       "6     Escritorio     Muebles        1           2500      0.15        Tarjeta   \n",
       "7      Impresora  Tecnología        1           3900         0  Transferencia   \n",
       "8          Papel     Oficina       10             85         0       Efectivo   \n",
       "9          Tinta     Oficina        2           -250         0       Efectivo   \n",
       "\n",
       "      Estado   Vendedor                     EmailCliente   Telefono  \\\n",
       "0     Pagado   M. Reyes            ana.lopez@example.com  9988-7766   \n",
       "1     Pagado   M. Reyes            ana.lopez@example.com  9988-7766   \n",
       "2     Pagado    A. Cruz         carlos.mejia@example.com  9999 1122   \n",
       "3     pagado    A. Cruz             maria.santos@example  8888-1234   \n",
       "4  Pendiente  L. Torres          jose.rivera@example.com  8877-6655   \n",
       "5  Cancelado  L. Torres         sofia.garcia@example.com  3366-2211   \n",
       "6     Pagado   M. Reyes        luis.martinez@example.com  9999-3344   \n",
       "7     Pagado    A. Cruz  cliente.desconocido@example.com  9988-1111   \n",
       "8  Entregado   M. Reyes          karla.nunez@example.com  2233-4455   \n",
       "9     Pagado  L. Torres         roberto.diaz@example.com  9988-2222   \n",
       "\n",
       "  TotalReportado                   Observaciones_Origen  \n",
       "0          13775                                         \n",
       "1          13775               Posible duplicado exacto  \n",
       "2            700                                         \n",
       "3            428                       Ciudad abreviada  \n",
       "4           3200                          Cantidad cero  \n",
       "5           3375  Fecha faltante; descuento como entero  \n",
       "6           2125                         Fecha inválida  \n",
       "7           3900                     ClienteId faltante  \n",
       "8            850               Estado fuera de catálogo  \n",
       "9           -500                        Precio negativo  "
      ]
     },
     "metadata": {},
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "10            MetodoPago           str               0               7\n",
       "11                Estado           str               1               9\n",
       "12              Vendedor           str               0               3\n",
       "13          EmailCliente           str               1              48\n",
       "14              Telefono           str               0              50\n",
       "15        TotalReportado        object               1              39\n",
       "16  Observaciones_Origen           str              15              38"
      ]
     },
     "metadata": {},
     "output_type": "display_data"
    ...
    },
    {
     "data": {
      "text/html": [
       ...
       "      <th>EmailValido</th>\n",
       "      <th>Telefono</th>\n",
       "      <th>TotalCalculado</th>\n",
       "      <th>TotalReportado</th>\n",
       "      <th>Diferencia</th>\n",
       "      <th>ObservacionesLimpieza</th>\n",
       "    </tr>\n",
       "  </thead>\n",
       "  <tbody>\n",
       "    <tr>\n",
       ...
       "      <td>13775.0</td>\n",
       "      <td>0.00</td>\n",
       "      <td>Registro limpio/normalizado</td>\n",
       "    </tr>\n",
       "    <tr>\n",
       "      <th>1</th>\n",
       "      <td>V-1002</td>\n",
       ...
       "      <td>428.0</td>\n",
       "      <td>0.03</td>\n",
       "      <td>Email inválido: maria.santos@example; TotalRep...</td>\n",
       "    </tr>\n",
       "    <tr>\n",
       "      <th>3</th>\n",
       "      <td>V-1013</td>\n",
       ...
       "      <td>Pagado</td>\n",
       "      <td>A. Cruz</td>\n",
       "      <td>mario.castro@example.com</td>\n",
       "      <td>Sí</td>\n",
       "      <td>9988-4444</td>\n",
       "      <td>1125.00</td>\n",
       "      <td>1250.0</td>\n",
       "      <td>125.00</td>\n",
       "      <td>TotalReportado difiere del TotalCalculado por ...</td>\n",
       "    </tr>\n",
       "    <tr>\n",
       "      <th>4</th>\n",
       "      <td>V-1014</td>\n",
       ...
       "      <td>Pagado</td>\n",
       "      <td>M. Reyes</td>\n",
       "      <td>paola.fernandez@example.com</td>\n",
       "      <td>Sí</td>\n",
       "      <td>9988-5555</td>\n",
       "      <td>2375.00</td>\n",
       "      <td>2375.0</td>\n",
      ...
      "text/plain": [
       "  IdVenta  FechaVenta ClienteId    ClienteNombre          Ciudad  \\\n",
       "0  V-1001  2026-05-01      C001        Ana López     Tegucigalpa   \n",
       "1  V-1002  2026-05-01      C002     Carlos Mejía  San Pedro Sula   \n",
       "2  V-1003  2026-05-02      C003     María Santos  San Pedro Sula   \n",
       "3  V-1013  2026-05-07      C013     Mario Castro        La Ceiba   \n",
       "4  V-1014  2026-05-08      C014  Paola Fernández         Choloma   \n",
       "\n",
       "        Producto   Categoria  Cantidad  PrecioUnitario  Descuento  \\\n",
       "0         Laptop  Tecnología         1         14500.0       0.05   \n",
       "1          Mouse  Tecnología         2           350.0       0.00   \n",
       "2        Teclado  Tecnología         1           450.5       0.05   \n",
       "3  Silla Oficina     Muebles         1          1250.0       0.10   \n",
       "4     Escritorio     Muebles         1          2500.0       0.05   \n",
       "\n",
       "      MetodoPago  Estado  Vendedor                 EmailCliente EmailValido  \\\n",
       "0        Tarjeta  Pagado  M. Reyes        ana.lopez@example.com          Sí   \n",
       "1       Efectivo  Pagado   A. Cruz     carlos.mejia@example.com          Sí   \n",
       "2  Transferencia  Pagado   A. Cruz         maria.santos@example          No   \n",
       "3       Efectivo  Pagado   A. Cruz     mario.castro@example.com          Sí   \n",
       "4  Transferencia  Pagado  M. Reyes  paola.fernandez@example.com          Sí   \n",
       "\n",
       "    Telefono  TotalCalculado  TotalReportado  Diferencia  \\\n",
       "0  9988-7766        13775.00         13775.0        0.00   \n",
       "1  9999 1122          700.00           700.0        0.00   \n",
       "2  8888-1234          427.97           428.0        0.03   \n",
       "3  9988-4444         1125.00          1250.0      125.00   \n",
       "4  9988-5555         2375.00          2375.0        0.00   \n",
       "\n",
       "                               ObservacionesLimpieza  \n",
       "0                        Registro limpio/normalizado  \n",
       "1                        Registro limpio/normalizado  \n",
       "2  Email inválido: maria.santos@example; TotalRep...  \n",
       "3  TotalReportado difiere del TotalCalculado por ...  \n",
       "4                        Registro limpio/normalizado  "
      ]
     },
     "metadata": {},
     "output_type": "display_data"
    },
    {
     "data": {
      "text/html": [
       ...
       "      <td>V-1001</td>\n",
       "      <td>3</td>\n",
       "      <td>Duplicado de IdVenta</td>\n",
       "      <td>IdVenta</td>\n",
       "      <td>V-1001</td>\n",
       "      <td>Enviar a revisión / corregir en origen</td>\n",
       "      <td>2026-05-28 16:25:51</td>\n",
       "      <td>Proceso automático</td>\n",
       "      <td>Posible duplicado exacto</td>\n",
       "    </tr>\n",
       "    <tr>\n",
       "      <th>1</th>\n",
       ...
       "      <td>V-1006</td>\n",
       "      <td>8</td>\n",
       "      <td>Fecha inválida: 2026-13-05</td>\n",
       "      <td>FechaVenta</td>\n",
       "      <td>2026-13-05</td>\n",
       "      <td>Enviar a revisión / corregir en origen</td>\n",
       "      <td>2026-05-28 16:25:51</td>\n",
      ...
      "text/plain": [
       "  IdVenta  FilaRaw               MotivoRechazo CampoAfectado ValorOriginal  \\\n",
       "0  V-1001        3        Duplicado de IdVenta       IdVenta        V-1001   \n",
       "1  V-1004        6        Cantidad inválida: 0      Cantidad             0   \n",
       "2  V-1005        7              Fecha faltante    FechaVenta                 \n",
       "3  V-1006        8  Fecha inválida: 2026-13-05    FechaVenta    2026-13-05   \n",
       "4  V-1007        9          ClienteId faltante     ClienteId                 \n",
       "\n",
       "                             AccionTomada        FechaRevision  \\\n",
       "0  Enviar a revisión / corregir en origen  2026-05-28 16:25:51   \n",
       "1  Enviar a revisión / corregir en origen  2026-05-28 16:25:51   \n",
       "2  Enviar a revisión / corregir en origen  2026-05-28 16:25:51   \n",
       "3  Enviar a revisión / corregir en origen  2026-05-28 16:25:51   \n",
       "4  Enviar a revisión / corregir en origen  2026-05-28 16:25:51   \n",
       "\n",
       "              Revisor                   Observaciones_Origen  \n",
       "0  Proceso automático               Posible duplicado exacto  \n",
       "1  Proceso automático                          Cantidad cero  \n",
       "2  Proceso automático  Fecha faltante; descuento como entero  \n",
       "3  Proceso automático                         Fecha inválida  \n",
       "4  Proceso automático                     ClienteId faltante  "
      ]
     },
     "metadata": {},
     "output_type": "display_data"
   ...
   "outputs": [
    {
     "data": {
      "text/html": [
       ...
       "    <tr>\n",
       "      <th>0</th>\n",
       "      <td>Total filas raw</td>\n",
       "      <td>52.00</td>\n",
       "      <td>Registros recibidos en Ventas_Raw</td>\n",
       "    </tr>\n",
       "    <tr>\n",
       "      <th>1</th>\n",
       "      <td>Total columnas raw</td>\n",
       "      <td>17.00</td>\n",
       "      <td>Columnas recibidas en Ventas_Raw</td>\n",
       "    </tr>\n",
       "    <tr>\n",
       "      <th>2</th>\n",
       "      <td>Registros válidos enviados a Silver</td>\n",
       "      <td>34.00</td>\n",
       "      <td>Filas que pasaron reglas críticas</td>\n",
       "    </tr>\n",
       "    <tr>\n",
       "      <th>3</th>\n",
       "      <td>Filas raw rechazadas</td>\n",
       "      <td>18.00</td>\n",
       "      <td>Filas con al menos un error crítico</td>\n",
       "    </tr>\n",
       "    <tr>\n",
       "      <th>4</th>\n",
       "      <td>Motivos de rechazo diferentes</td>\n",
       "      <td>17.00</td>\n",
       "      <td>Tipos de problemas detectados</td>\n",
       "    </tr>\n",
       "    <tr>\n",
       "      <th>5</th>\n",
       "      <td>Total calculado Silver</td>\n",
       "      <td>128757.97</td>\n",
       "      <td>Ventas calculadas usando registros limpios</td>\n",
       "    </tr>\n",
       "    <tr>\n",
       "      <th>6</th>\n",
       "      <td>Registros con diferencia de total</td>\n",
       "      <td>4.00</td>\n",
       "      <td>Filas válidas donde TotalReportado no coincide...</td>\n",
       "    </tr>\n",
       "  </tbody>\n",
       "</table>\n",
       "</div>"
      ...
      "text/plain": [
       "                               Métrica      Valor  \\\n",
       "0                      Total filas raw      52.00   \n",
       "1                   Total columnas raw      17.00   \n",
       "2  Registros válidos enviados a Silver      34.00   \n",
       "3                 Filas raw rechazadas      18.00   \n",
       "4        Motivos de rechazo diferentes      17.00   \n",
       "5               Total calculado Silver  128757.97   \n",
       "6    Registros con diferencia de total       4.00   \n",
       "\n",
       "                                      Interpretación  \n",
       "0                  Registros recibidos en Ventas_Raw  \n",
       "1                   Columnas recibidas en Ventas_Raw  \n",
       "2                  Filas que pasaron reglas críticas  \n",
       "3                Filas con al menos un error crítico  \n",
       "4                      Tipos de problemas detectados  \n",
       "5         Ventas calculadas usando registros limpios  \n",
       "6  Filas válidas donde TotalReportado no coincide...  "
      ]
     },
     "metadata": {},
     "output_type": "display_data"
    ...
    },
    {
     "data": {
      "text/html": [
       ...
       "    <tr>\n",
       "      <th>1</th>\n",
       "      <td>Cantidad inválida: -1</td>\n",
       "      <td>1</td>\n",
       "    </tr>\n",
       "    <tr>\n",
       "      <th>3</th>\n",
       "      <td>Cantidad no numérica: dos</td>\n",
       "      <td>1</td>\n",
       "    </tr>\n",
       "    <tr>\n",
       "      <th>2</th>\n",
       ...
       "    <tr>\n",
       "      <th>6</th>\n",
       "      <td>ClienteNombre faltante</td>\n",
       "      <td>1</td>\n",
       "    </tr>\n",
       "    <tr>\n",
       "      <th>7</th>\n",
       "      <td>Descuento fuera de rango: 1.2</td>\n",
       "      <td>1</td>\n",
       "    </tr>\n",
       "    <tr>\n",
       "      <th>9</th>\n",
       "      <td>Estado faltante</td>\n",
       "      <td>1</td>\n",
       "    </tr>\n",
       "    <tr>\n",
       "      <th>10</th>\n",
       "      <td>Estado fuera de catálogo: Anulado</td>\n",
       "      <td>1</td>\n",
       "    </tr>\n",
       "    <tr>\n",
       "      <th>11</th>\n",
       "      <td>Estado fuera de catálogo: Entregado</td>\n",
       "      <td>1</td>\n",
       "    </tr>\n",
       "    <tr>\n",
       "      <th>12</th>\n",
       ...
       "    <tr>\n",
       "      <th>14</th>\n",
       "      <td>MetodoPago fuera de catálogo: PayPal</td>\n",
       "      <td>1</td>\n",
       "    </tr>\n",
       "    <tr>\n",
       "      <th>15</th>\n",
       "      <td>Precio inválido: -250.0</td>\n",
       "      <td>1</td>\n",
       "    </tr>\n",
       "    <tr>\n",
       "      <th>16</th>\n",
       "      <td>Valor no numérico: N/A</td>\n",
       "      <td>1</td>\n",
       "    </tr>\n",
       "  </tbody>\n",
       "</table>\n",
      ...
      "text/plain": [
       ...
       "9                        Estado faltante         1\n",
       "10     Estado fuera de catálogo: Anulado         1\n",
       "11   Estado fuera de catálogo: Entregado         1\n",
       "12                        Fecha faltante         1\n",
       "13            Fecha inválida: 2026-13-05         1\n",
       "14  MetodoPago fuera de catálogo: PayPal         1\n",
       "15               Precio inválido: -250.0         1\n",
       "16                Valor no numérico: N/A         1"
      ]
     },
     "metadata": {},
     "output_type": "display_data"
  ...
  },
  {
   ...
   "id": "6d757a63-d1a9-4ef5-af84-45417dcbeead",
   "metadata": {},
   "outputs": [],
   "source": []
  }
